...
public final class InitializeMoves {
	...
	private static Map<Integer, Move> mewMap;	private static Map<Integer, Move> rayquazaMap;
    ...
    private static void initializeMoves() {
        ...
        ivysaurMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.IVYSAUR.initializeMoveset(ivysaurMap);
        
        /*Initialization of Venusaur Evo */
        venusaurMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.VENUSAUR.initializeMoveset(venusaurMap);
        
        
        /*Initialization of charmander Evo */
        ...
        /*Initialization of charmeleon Evo */
        charmeleonMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.CHARMELEON.initializeMoveset(charmeleonMap);
        
        /*Initialization of charizard Evo */
        charizardMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.CHARIZARD.initializeMoveset(charizardMap);
        
        /*Initialization of squirtle using Guava immutableMap*/
        ...
        /*Initialization of wartortle using Guava immutableMap*/
        wartortleMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.WARTORTLE.initializeMoveset(wartortleMap);
        
        /*Initialization of blastoise using Guava immutableMap*/
        blastoiseMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.BLASTOISE.initializeMoveset(blastoiseMap);
   
        /*Initialization of Caterpie Evo */
        caterpieMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.TACKLE)
                .put(1, Move.STRING_SHOT)
                .build();
        Pokedex.CATERPIE.initializeMoveset(caterpieMap);
        
        /*Initialization of Metapod Evo */
        metapodMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.HARDEN)
                .put(7, Move.HARDEN)
                .build();
        Pokedex.METAPOD.initializeMoveset(metapodMap);
        
        /*Initialization of Butterfree Evo */
        butterfreeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.BUTTERFREE.initializeMoveset(butterfreeMap);
        
        /*Initialization of Weedle Evo */
        weedleMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.POISON_STING)
                .put(1, Move.STRING_SHOT)
                .build();
        Pokedex.WEEDLE.initializeMoveset(weedleMap);
        
        /*Initialization of Kakuna Evo */
        kakunaMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.HARDEN)
                .put(7, Move.HARDEN)
                .build();
        Pokedex.KAKUNA.initializeMoveset(kakunaMap);
        
        /*Initialization of Beedrill Evo */
        beedrillMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.FURY_ATTACK)
                .put(10, Move.FURY_ATTACK)
                ...
                .put(40, Move.AGILITY)
                .build();
        Pokedex.BUTTERFREE.initializeMoveset(beedrillMap);
        ...
        /*Initialization of Pidgeotto Evo */
        pidgeottoMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(43, Move.AGILITY)
                .build();
        Pokedex.PIDGEOTTO.initializeMoveset(pidgeottoMap);
        
        /*Initialization of Pidgeot Evo */
        pidgeotMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(48, Move.AGILITY)
                .build();
        Pokedex.PIDGEOT.initializeMoveset(pidgeotMap);
        ...
        /*Initialization of Raticate Evo */
        raticateMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(30, Move.PURSUIT)
                .build();
        Pokedex.RATICATE.initializeMoveset(raticateMap);
        
        /*Initialization of Spearow Evo */
        spearowMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(43, Move.AGILITY)
                .build();
        Pokedex.SPEAROW.initializeMoveset(spearowMap);
        
        /*Initialization of Fearow Evo */
        fearowMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(47, Move.AGILITY)
                .build();
        Pokedex.FEAROW.initializeMoveset(fearowMap);

        /*Initialization of Ekans Evo */
        ekansMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(327, Move.ACID)
                .build();
        Pokedex.EKANS.initializeMoveset(ekansMap);

        /*Initialization of Arbok Evo */
        ...
        raichuMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(41, Move.THUNDER)
                .build();
        Pokedex.RAICHU.initializeMoveset(raichuMap);
        
        /*Initialization of Sandshrew Evo*/
        ...
        /*Initialization of Sandslash Evo*/
        sandslashMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.SANDSLASH.initializeMoveset(sandslashMap);
        
        /*Initialization of NidoranF Evo*/
        nidoranfMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(47, Move.CRUNCH)
                .build();
        Pokedex.NIDORANF.initializeMoveset(nidoranfMap);
        ...
        nidorinaMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(53, Move.CRUNCH)
                .build();
        Pokedex.NIDORINA.initializeMoveset(nidorinaMap);

        /*Initialization of Nidoqueen Evo*/
        nidoqueenMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(46, Move.CRUNCH)
                .build();
        Pokedex.NIDOQUEEN.initializeMoveset(nidoqueenMap);

        /*Initialization of NidoranM Evo*/
        nidoranmMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.NIDORANM.initializeMoveset(nidoranmMap);

        /*Initialization of Nidorino Evo*/
        nidorinoMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.NIDORINO.initializeMoveset(nidorinoMap);
        
        /*Initialization of Nidoking Evo*/
        nidokingMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.NIDOKING.initializeMoveset(nidokingMap);
        
        /*Initialization of Clefairy Evo*/
        clefairyMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.CLEFAIRY.initializeMoveset(clefairyMap);
        
        /*Initialization of Clefable Evo*/
        clefableMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.CLEFABLE.initializeMoveset(clefableMap);
        
        /*Initialization of Vulpix Evo*/
        vulpixMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.VULPIX.initializeMoveset(vulpixMap);
        
        /*Initialization of Ninetales Evo*/
        ninetalesMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.NINETALES.initializeMoveset(ninetalesMap);
        
        /*Initialization of Jigglypuff Evo*/
        jigglypuffMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.JIGGLYPUFF.initializeMoveset(jigglypuffMap);
        
        /*Initialization of Wigglytuff Evo*/
        wigglytuffMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(60, Move.HYPER_BEAM)
                .build();
        Pokedex.WIGGLYTUFF.initializeMoveset(wigglytuffMap);
        
        /*Initialization of Zubat Evo*/
        ...
        golbatMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.GOLBAT.initializeMoveset(golbatMap);
        
        /*Initialization of Oddish Evo*/
        oddishMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.ABSORB)
                .put(10, Move.ACID)
                .put(39, Move.PETAL_DANCE)
                .build();
        Pokedex.ODDISH.initializeMoveset(oddishMap);
        
        /*Initialization of Gloom Evo*/
        gloomMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.ABSORB)
                .put(19, Move.ACID)
                .put(36, Move.PETAL_DANCE)
                .build();
        Pokedex.GLOOM.initializeMoveset(gloomMap);
        
        /*Initialization of Vileplume Evo*/
        vileplumeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.VILEPLUME.initializeMoveset(vileplumeMap);
        
        /*Initialization of Paras Evo*/
        parasMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PARAS.initializeMoveset(parasMap);
        
        /*Initialization of Parasect Evo*/
        parasectMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PARASECT.initializeMoveset(parasectMap);
        
        /*Initialization of Venonat Evo*/
        venonatMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(41, Move.PSYCHIC)
                .build();
        Pokedex.VENONAT.initializeMoveset(venonatMap);
        
        /*Initialization of Venomoth Evo*/
        venomothMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(45, Move.PSYCHIC)
                .build();
        Pokedex.VENOMOTH.initializeMoveset(venomothMap);
        
        /*Initialization of Diglett Evo*/
        diglettMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.DIGLETT.initializeMoveset(diglettMap);
        
        /*Initialization of Dugtrio Evo*/
        dugtrioMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.DUGTRIO.initializeMoveset(dugtrioMap);
        
        /*Initialization of Meowth Evo*/
        meowthMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.MEOWTH.initializeMoveset(meowthMap);
        
        /*Initialization of Persian Evo*/
        persianMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PERSIAN.initializeMoveset(persianMap);
        
        /*Initialization of Psyduck Evo*/
        psyduckMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PSYDUCK.initializeMoveset(psyduckMap);
        
        /*Initialization of Golduck Evo*/
        golduckMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(40, Move.HYDRO_PUMP)
                .build();
        Pokedex.GOLDUCK.initializeMoveset(golduckMap);
        
        /*Initialization of Mankey Evo*/
        mankeyMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.MANKEY.initializeMoveset(mankeyMap);
        
        /*Initialization of Primeape Evo*/
        primeapeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PRIMEAPE.initializeMoveset(primeapeMap);
        
        /*Initialization of Growlithe Evo*/
        growlitheMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.GROWLITHE.initializeMoveset(growlitheMap);
        
        /*Initialization of Arcanine Evo*/
        arcanineMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.ARCANINE.initializeMoveset(arcanineMap);
        
        /*Initialization of Poliwag Evo*/
        poliwagMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.POLIWAG.initializeMoveset(poliwagMap);
        
        /*Initialization of Poliwhirl Evo*/
        poliwhirlMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.POLIWHIRL.initializeMoveset(poliwhirlMap);
        
        /*Initialization of Poliwrath Evo*/
        poliwrathMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.POLIWRATH.initializeMoveset(poliwrathMap);
        
        /*Initialization of Abra Evo*/
        abraMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(34, Move.PSYCHIC)
                .build();
        Pokedex.ABRA.initializeMoveset(abraMap);
        
        /*Initialization of Kadabra Evo*/
        kadabraMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(38, Move.PSYCHIC)
                .build();
        Pokedex.KADABRA.initializeMoveset(kadabraMap);
        
        /*Initialization of Alakazam Evo*/
        alakazamMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(43, Move.PSYCHIC)
                .build();
        Pokedex.ALAKAZAM.initializeMoveset(alakazamMap);
        
        /*Initialization of Machop Evo*/
        machopMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.LEER)
                .put(1, Move.KARATE_CHOP)
                .put(15, Move.REVENGE)
                ...
                .build();
        Pokedex.MACHOP.initializeMoveset(machopMap);
        
        /*Initialization of Machoke Evo*/
        machokeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.MACHOKE.initializeMoveset(machokeMap);
        
        /*Initialization of Machamp Evo*/
        machampMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(59, Move.FOCUS_PUNCH)
                .build();
        Pokedex.MACHAMP.initializeMoveset(machampMap);
        
        /*Initialization of Bellsprout Evo*/
        bellsproutMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(43, Move.SLAM)
                .build();
        Pokedex.BELLSPROUT.initializeMoveset(bellsproutMap);
        
        /*Initialization of Weepinbell Evo*/
        weepinbellMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(40, Move.SLAM)
                .build();
        Pokedex.WEEPINBELL.initializeMoveset(weepinbellMap);
        
        /*Initialization of Victreebel Evo*/
        victreebelMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(50, Move.SOLAR_BEAM)
                .build();
        Pokedex.VICTREEBEL.initializeMoveset(victreebelMap);
        
        /*Initialization of Tentacool Evo*/
        ...
        /*Initialization of Tentacruel Evo*/
        tentacruelMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(60, Move.HYPER_BEAM)
                .build();
        Pokedex.TENTACRUEL.initializeMoveset(tentacruelMap);
        
        /*Initialization of Geodude Evo*/
        geodudeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.GEODUDE.initializeMoveset(geodudeMap);
        
        /*Initialization of Graveler Evo*/
        gravelerMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(50, Move.DOUBLE_EDGE)
                .build();
        Pokedex.GRAVELER.initializeMoveset(gravelerMap);
        
        /*Initialization of Golem Evo*/
        golemMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(60, Move.HYPER_BEAM)
                .build();
        Pokedex.GOLEM.initializeMoveset(golemMap);
        
        /*Initialization of Ponyta Evo*/
        ponytaMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.PONYTA.initializeMoveset(ponytaMap);
        
        /*Initialization of Rapidash Evo*/
        rapidashMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.RAPIDASH.initializeMoveset(rapidashMap);
        
        /*Initialization of Slowpoke Evo*/
        slowpokeMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(48, Move.SURF)
                .build();
        Pokedex.SLOWPOKE.initializeMoveset(slowpokeMap);
        
        /*Initialization of Slowbro Evo*/
        slowbroMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(60, Move.FIRE_BLAST)
                .build();
        Pokedex.SLOWBRO.initializeMoveset(slowbroMap);
        
        /*Initialization of Magnemite Evo*/
        magnemiteMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(50, Move.THUNDER)
                .build();
        Pokedex.MAGNEMITE.initializeMoveset(magnemiteMap);
        
        /*Initialization of Magneton Evo*/
        magnetonMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(55, Move.THUNDER)
                .build();
        Pokedex.MAGNETON.initializeMoveset(magnetonMap);
        
        /*Initialization of Farfetchd Evo*/
        farfetchdMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.FARFETCHD.initializeMoveset(farfetchdMap);
        ...
        doduoMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(50, Move.HYPER_BEAM)
                .build();
        Pokedex.DODUO.initializeMoveset(doduoMap);
        
        /*Initialization of Dodrio Evo*/
        dodrioMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.DODRIO.initializeMoveset(dodrioMap);
        
        /*Initialization of Seel Evo*/
        seelMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(35, Move.SURF)
                .build();
        Pokedex.SEEL.initializeMoveset(seelMap);
        
        /*Initialization of Dewgong Evo*/
        dewgongMap = ImmutableMap.<Integer, Move>builder()
                ...
                .build();
        Pokedex.DEWGONG.initializeMoveset(dewgongMap);
        ...
        hitmonchanMap = ImmutableMap.<Integer, Move>builder()
                ...
                .put(26, Move.ICE_PUNCH)
                .put(26, Move.FIRE_PUNCH)
        ...
        jynxMap = ImmutableMap.<Integer, Move>builder()
                .put(1, Move.POUND)
                .put(1, Move.LICK)
                .put(1, Move.POWDER_SNOW)
                .put(13, Move.POWDER_SNOW)
