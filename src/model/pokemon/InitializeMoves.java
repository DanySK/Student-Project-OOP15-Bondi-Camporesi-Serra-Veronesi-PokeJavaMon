...
//                    .put(1, Move.ABSORB7
            ...
            mewtwoMap = ImmutableMap.<Integer, Move>builder()
                    ...
                    .put(50, Move.EARTHQUAKE)
                    .put(71, Move.THUNDER)
                    .put(72, Move.FIRE_BLAST)
                    .put(73, Move.BLIZZARD)
            ...
            mewMap = ImmutableMap.<Integer, Move>builder()
            		.put(1, Move.RAGE)			
                    .put(10, Move.POUND)        	
                    .put(14, Move.CALM_MIND)
                    .put(18, Move.PAY_DAY)		
                    .put(22, Move.WATER_GUN)
                    .put(26, Move.MEGA_DRAIN)
                    .put(30, Move.LIGHT_SCREEN)
                    .put(33, Move.CUT)			
                    .put(36, Move.BUBBLE_BEAM)
                    .put(39, Move.ANCIENT_POWER)
                    .put(42, Move.BARRIER)
                    .put(45, Move.SWIFT)			
                    .put(48, Move.DRAGON_RAGE)
                    .put(50, Move.ROCK_SLIDE)
                    .put(52, Move.BULK_UP)
                    .put(54, Move.STRENGTH)		
                    .put(56, Move.SUBMISSION)
                    .put(58, Move.TRI_ATTACK)	
                    .put(60, Move.AMNESIA)
                    .put(61, Move.RAZOR_WIND) 	
                    .put(62, Move.FLY)
                    .put(63, Move.BODY_SLAM)	
                    .put(64, Move.DIG)
                    .put(65, Move.TAIL_GLOW)
                    .put(66, Move.TAKE_DOWN)	
                    .put(67, Move.SURF)
                    .put(68, Move.EARTHQUAKE)
                    .put(69, Move.PSYCHIC)
                    .put(70, Move.THUNDERBOLT)
                    .put(71, Move.ICE_BEAM)
                    .put(72, Move.SWORDS_DANCE)
                    .put(73, Move.DOUBLE_EDGE)	
                    .put(74, Move.MEGA_PUNCH)	
                    .put(75, Move.MEGA_KICK)	
                    .put(76, Move.SKULL_BASH)	
                    .put(77, Move.THUNDER)
                    .put(78, Move.FIRE_BLAST)
                    .put(79, Move.BLIZZARD)
                    .put(80, Move.SOLAR_BEAM)
                    .put(81, Move.HYPER_BEAM)
                    .put(82, Move.SKY_ATTACK)
                    .put(83, Move.EGG_BOMB)
                    .put(84, Move.EXPLOSION)
                    .put(85, Move.OUTRAGE)
                    .put(86, Move.BLAST_BURN)
                    .put(87, Move.FRENZY_PLANT)
                    .put(88, Move.HYDRO_CANNON)
                    .put(89, Move.VOLT_TACKLE)
                    .put(90, Move.FUTURE_SIGHT)
                    .put(91, Move.DOOM_DESIRE)
                    .put(92, Move.V_CREATE)
                    .put(93, Move.DRAGON_ASCENT)
                    .put(94, Move.PSYCHO_BOOST)
                    .put(95, Move.SPLASH)
                    .put(100, Move.SPLASH)
            .build();
