...
public enum Pokedex {
    ...
    MEWTWO("Mewtwo",         PokemonType.PSYCHIC, PokemonType.NONE,    106, 154,  90, 130,  PokemonRarity.LEGENDARY,  -1,           "", new HashMap<>(), FrontSpriteImage.MEWTWO,     BackSpriteImage.MEWTWO),
