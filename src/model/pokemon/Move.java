...
//    DRACO_METEOR(PokemonType.DRAGON, Stat.HP, MoveType.PHYSICAL, true, 130),
    ...
    EXTRASENSORY(PokemonType.PSYCHIC, Stat.MAX_HP, MoveType.SPECIAL, true, 80),
    ...
    FLY(PokemonType.FLYING, Stat.MAX_HP, MoveType.PHYSICAL, true, 90),
    ...
    PSYBEAM(PokemonType.PSYCHIC, Stat.MAX_HP, MoveType.SPECIAL, true, 65),
