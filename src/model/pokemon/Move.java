...
DOUBLE_SLAP(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 15),
COMET_PUNCH(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 18),
...
FLY(PokemonType.FLYING, Stat.HP, MoveType.PHYSICAL, true, 90),
BIND(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 15),
SLAM(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 80),
VINE_WHIP(PokemonType.GRASS, Stat.HP, MoveType.PHYSICAL, true, 45),
STOMP(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 65),
DOUBLE_KICK(PokemonType.FIGHT, Stat.HP, MoveType.PHYSICAL, true, 30),
...
FURY_ATTACK(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 15),
...
WRAP(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 15),
TAKE_DOWN(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 90),
THRASH(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 120),
...
TWINEEDLE(PokemonType.BUG, Stat.HP, MoveType.PHYSICAL, true, 25),
PIN_MISSILE(PokemonType.BUG, Stat.HP, MoveType.PHYSICAL, true, 25),
...
STRENGTH(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 80),
ABSORB(PokemonType.GRASS, Stat.HP, MoveType.SPECIAL, true, 20),
MEGA_DRAIN(PokemonType.GRASS, Stat.HP, MoveType.SPECIAL, true, 40),
...
SOLAR_BEAM(PokemonType.GRASS, Stat.HP, MoveType.SPECIAL, true, 120),
PETAL_DANCE(PokemonType.GRASS, Stat.HP, MoveType.SPECIAL, true, 120),
...
RAGE(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 20),
...
SPIKE_CANNON(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 20),
CONSTRICT(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 10),
...
BARRAGE(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 15),
LEECH_LIFE(PokemonType.BUG, Stat.HP, MoveType.PHYSICAL, true, 20),
...
FURY_SWIPES(PokemonType.NORMAL, Stat.HP, MoveType.PHYSICAL, true, 18),
BONEMERANG(PokemonType.GROUND, Stat.HP, MoveType.PHYSICAL, true, 50),
...
TRIPLE_KICK(PokemonType.FIGHT, Stat.HP, MoveType.PHYSICAL, true, 10),
...
MUD_SLAP(PokemonType.GROUND, Stat.HP, MoveType.SPECIAL, true, 20),
...
BONE_RUSH(PokemonType.GROUND, Stat.HP, MoveType.PHYSICAL, true, 25),
OUTRAGE(PokemonType.DRAGON, Stat.HP, MoveType.PHYSICAL, true, 120),
GIGA_DRAIN(PokemonType.GRASS, Stat.HP, MoveType.SPECIAL, true, 75),
ROLLOUT(PokemonType.ROCK, Stat.HP, MoveType.PHYSICAL, true, 30),
...
STEEL_WING(PokemonType.STEEL, Stat.HP, MoveType.PHYSICAL, true, 70),
...
METAL_CLAW(PokemonType.STEEL, Stat.HP, MoveType.PHYSICAL, true, 50),
...
ANCIENT_POWER(PokemonType.ROCK, Stat.HP, MoveType.SPECIAL, true, 60),
...
UPROAR(PokemonType.NORMAL, Stat.HP, MoveType.SPECIAL, true, 90),
...
ARM_THRUST(PokemonType.FIGHT, Stat.HP, MoveType.PHYSICAL, true, 15),
...
ICE_BALL(PokemonType.ICE, Stat.HP, MoveType.PHYSICAL, true, 30),
...
BULLET_SEED(PokemonType.GRASS, Stat.HP, MoveType.PHYSICAL, true, 25),
...
VOLT_TACKLE(PokemonType.ELECTR, Stat.HP, MoveType.PHYSICAL, true, 120),
...
ROCK_BLAST(PokemonType.ROCK, Stat.HP, MoveType.PHYSICAL, true, 25),
